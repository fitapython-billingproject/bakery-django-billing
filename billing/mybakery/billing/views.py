...
from .models import Bill, BillItem, Customer_details
...
def save_bill(request):
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            final_total = round(subtotal_after_discount + gst_amount)

            # Assign values to the bill model fields
...
def send_bill_email(request, bill_id):
    ...
    FONT_DIR = r"C:\Users\91638\OneDrive\Desktop\billing\mybakery\dejavu-fonts-ttf-2.37\ttf"
    pdfmetrics.registerFont(TTFont("DejaVuSans",          fr"{FONT_DIR}\DejaVuSans.ttf"))
    pdfmetrics.registerFont(TTFont("DejaVuSans-Bold",     fr"{FONT_DIR}\DejaVuSans-Bold.ttf"))
    pdfmetrics.registerFont(TTFont("DejaVuSans-Oblique",  fr"{FONT_DIR}\DejaVuSans-Oblique.ttf"))
    pdfmetrics.registerFont(TTFont("DejaVuSans-BoldOblique", fr"{FONT_DIR}\DejaVuSans-BoldOblique.ttf"))
    registerFontFamily(
        "DejaVuSans",
        normal="DejaVuSans",
